...
const isRegexp = __webpack_require__(9689);
...
const cloneRegexp = __webpack_require__(7872);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var requestconf_1 = __importDefault(__webpack_require__(6323));
var core = __importStar(__webpack_require__(2186));
var fs = __importStar(__webpack_require__(5747));
var util_1 = __webpack_require__(2629);
try {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
var core = __importStar(__webpack_require__(2186));
var util = __importStar(__webpack_require__(2629));
...
if (core.getInput('data')) {
    config.data = util_1.getEscapeString(core.getInput('data'));
}
if (core.getInput('headers')) {
    config.headers = JSON.parse(util_1.getEscapeString(core.getInput('headers')));
}
if (config.data) {
    // try parse data
    try {
...
if (core.getInput('content-type')) {
    config.headers = __assign(__assign({}, config.headers), { 'Content-Type': core.getInput('content-typen') });
}
if (core.getInput('params')) {
    config.params = JSON.parse(util_1.getEscapeString(core.getInput('params')));
}
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getEscapeString = exports.sendRequestWithRetry = exports.buildOutput = exports.validateStatusCode = void 0;
var core = __importStar(__webpack_require__(2186));
var axios_1 = __importDefault(__webpack_require__(6545));
var output_1 = __importDefault(__webpack_require__(5768));
var execall_1 = __importDefault(__webpack_require__(7514));
...
function getEscapeString(str) {
    if (str) {
        ...
        var endSyntax = ">>>";
        // regex
        var regex = new RegExp(startSyntax + "([\\S\\s]*?)" + endSyntax, "gm");
        var matched_1 = execall_1.default(regex, str);
        if (matched_1.length > 0) {
            var strArr_1 = [];
            // add first matched
            var currentEndIndex_1 = 0;
            if (matched_1[0].index > 0) {
                strArr_1.push(str.slice(0, matched_1[0].index));
                currentEndIndex_1 = matched_1[0].index;
            }
            matched_1.forEach(function (matchedItem, index) {
                var replaceResult = matchedItem.subMatches[0].replace(/[\\]/g, '\\\\')
                    .replace(/[\/]/g, '\\/')
                    .replace(/[\b]/g, '\\b')
                    .replace(/[\f]/g, '\\f')
                    .replace(/[\n]/g, '\\n')
                    ...
                    .replace(/[\"]/g, '\\"')
                    .replace(/\\'/g, "\\'");
                strArr_1.push(replaceResult);
                currentEndIndex_1 = matchedItem.match.length + matchedItem.index;
                // push to next 
                if (matched_1[index + 1]) {
                    var nextIndex = matched_1[index + 1].index;
                    if (nextIndex > currentEndIndex_1) {
                        strArr_1.push(str.slice(currentEndIndex_1, nextIndex));
                        currentEndIndex_1 = nextIndex;
                    }
                }
                else {
                    // no next
                    if (str.length > currentEndIndex_1) {
                        strArr_1.push(str.slice(currentEndIndex_1, str.length));
                        currentEndIndex_1 = str.length;
                    }
                }
            });
            return strArr_1.join('');
        }
        else {
            return str;
        }
...
exports.getEscapeString = getEscapeString;
